...
create table senac(
	...
	id_endereco int,
	unidade varchar(50) UNIQUE,
	telefone char(10),
	zona varchar(50),
	foreign key	(id_endereco) references endereco(id_endereco)
);
exec sp_rename 'senac.unidadade', 'unidade';
...
insert into aluno(id_endereco, cpf, nome, email, telefone, data_nascimento, genero, curso, qnt_cursos, id_curso)
values
(21, '57835957485', 'Valéria', 'valeria.sodre@gmail.com', '84998328485', '2005-05-17', 'Feminino', 'Técnico em desenvolvimento de sistemas', 1, 5),
(19, '11667438450', 'Mateus', 'matheus.paixao@gmail.com', '84983261139', '2000-03-10', 'Masculino', 'Técnico em desenvolvimento de sistemas', 1, 3),
(17, '86450619457', 'Lorenzo', 'lorentralha@gmail.com', '84984816207', '2002-11-08', 'Masculino', 'Desenvolvedor Fullstack', 1, 1),
(15, '72746163403', 'Júlia', 'jullinhabay@gmail.com', '84991504148', '1998-01-09', 'Feminino', 'Comércio e Dev Fullstack', 2, 1);
select * from aluno;
